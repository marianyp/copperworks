...
public record MufflerUpdatedPayload(ChunkPos chunkPos, BlockPos blockPos, boolean removed) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, MufflerUpdatedPayload> CODEC = PacketCodec.tuple(
            ...
            BlockPos.PACKET_CODEC, MufflerUpdatedPayload::blockPos, PacketCodecs.BOOL, MufflerUpdatedPayload::removed,
            MufflerUpdatedPayload::new);
